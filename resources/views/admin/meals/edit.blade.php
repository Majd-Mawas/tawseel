@extends('layouts.vertical', ['title' => 'Edit Meal', 'sub_title' => 'Menu', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="w-full">
                ...
                <div class="card">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <form
                            action="{{ route('admin.restaurants.meals.update', ['restaurant' => $restaurant, 'meal' => $meal]) }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="space-y-6">
                                <div>
                                    <label for="meal-name" class="block text-sm font-medium text-gray-700">Meal
                                        Name</label>
                                    <input type="text" id="meal-name" name="name"
                                ...
                                <div>
                                    ...
                                    <textarea id="meal-description" name="description" rows="4" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $meal->description) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    @if ($meal->getFirstMediaUrl('image'))
                                        <div class="mt-2">
                                            <img src="{{ $meal->getFirstMediaUrl('image') }}" alt="Meal Image"
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('admin.restaurants.meals.index', ['restaurant' => $restaurant]) }}"
