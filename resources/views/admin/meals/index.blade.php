                ...
                <div class="card">
                    <div class="shadow rounded-lg">
                        <div class="card-header flex justify-between items-center">
                            ...
                            <a href="{{ route('admin.restaurants.meals.create', ['restaurant' => $restaurant]) }}"
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($meals as $meal)
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm ">
                                                            {{ number_format((float) $meal->price, 2) }} S.P.
                                                        </div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm ">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <a href="{{ route('admin.restaurants.meals.edit', ['restaurant' => $restaurant, 'meal' => $meal]) }}"
                                                            class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                                        <form
                                                            action="{{ route('admin.restaurants.meals.destroy', ['restaurant' => $restaurant, 'meal' => $meal]) }}"
