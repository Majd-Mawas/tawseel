@extends('layouts.vertical', ['title' => 'Edit Category', 'sub_title' => 'Menu', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="category-type" name="type" required
                                        ...
                                        <option value="restaurant"
                                            {{ old('type', $category->type) === 'restaurant' ? 'selected' : '' }}>
                                            Restaurant</option>
                                        <option value="shop_center"
                                            {{ old('type', $category->type) === 'shop_center' ? 'selected' : '' }}>
                                            Shop Center</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    @if ($category->getFirstMediaUrl('image'))
                                        <div class="mt-2">
                                            <img src="{{ $category->getFirstMediaUrl('image') }}" alt="Category Image"
